  ...
  return (
    <>
      ...
      <Pdf targetRef={ref} filename='course-details.pdf'>
        {({ toPdf }) => (
          <button className='bg-purple-700 h-10 w-20 lg:ml-96 md:ml-80 sm:ml-64 rounded-lg font-bold hover:bg-orange-500' onClick={toPdf}>
            Click me
          </button>
        )}
      </Pdf>
        <div ref={ref}>
        <div  className='flex space-x-4 mb-3' bis_skin_checked='1'>
          <img
            alt=''
          ...
          <div className='flex flex-col space-y-1' bis_skin_checked='1'>
            ...
            <span className='text-xs dark:text-gray-400'>Kit korner</span>
          </div>
        </div>
        ...
        <div className='flex flex-wrap justify-between' bis_skin_checked='1'>
          ...
          >
            ...
            <button className='flex items-center p-1 space-x-1.5'>
              <FaPaypal className='w-4 h-4 fill-current dark:text-violet-400'></FaPaypal>
              {total}$
            </button>
          </div>
        </div>
        ...
        <Link to={`/single-course-details/${id}`}>
          <button className='bg-purple-500 lg:mx-32 p-5 rounded-lg hover:bg-orange-500 font-bold'>
            Get Premuim Access
          </button>
        </Link>
      </div>
